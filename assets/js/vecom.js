...
function trap(e){
  const open = $("#cart").classList.contains("on") ? $("#cart")
             : $("#modal").classList.contains("on") ? $("#modal") : null;
